...
const About = () => {
  return (
      <div className={styles.page}>
        ...
        Welcome to Scholarly! We are a tutoring app designed to provide 
        students with a personalized and engaging learning experience. 
         Our team of three developers created Scholarly with the goal of 
        making education more accessible and enjoyable for everyone.</h3>
        ...
        schedule and manage tutoring sessions according to your own availability.
        </p>
        <p className={styles.primarytext}>
        At Scholarly, we understand that every student has unique learning needs
         and styles. Our tutors are highly qualified and experienced in 
         their respective fields, ensuring that you receive the best
        ...
        <p className={styles.primarytext}>
        Thank you for choosing Scholarly as your go-to tutoring app. 
         We are dedicated to providing you with the best possible learning 
        experience, and we look forward to helping you achieve your full potential.
        </p>     
      </div>
  );
};
